...
<head>
    ...
    <link href="{{ asset('build/assets/font-awesome/css/all.min.css') }}" rel="stylesheet" type="text/css">
    <link
    ...
    <link href="{{ asset('build/assets/sweetallert/sweetalert2.min.css') }}" rel="stylesheet">
    <link href="{{ asset('build/assets/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet">
    <link href="{{ asset('build/assets/select2/select2.min.css') }}" rel="stylesheet">
    <link href="{{ asset('build/assets/select2/select2-bootstrap.min.css') }}" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar accordion" id="accordionSidebar"
            style="border-right: 4px solid rgb(235, 235, 235)">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="{{ url('/master/users') }}">User</a>
                            <a class="collapse-item" href="{{ url('/master/roles') }}">Role</a>
    ...
    <script src="{{ asset('build/assets/sweetallert/sweetalert2.all.min.js') }}"></script>
