...
class Proforma
{
    public static function generate($inv_num)
    {
        ...
        $pdf->Cell(0, 10, 'PROFORMA INVOICE', 0, 0, 'C');
        $pdf->Ln(8);
        ...
        $pdf->Cell(30, 5, $pdf->qrCode(env('APP_URL') . 'invoices/proforma-invoice/' . $inv_num, 80, $pdf->GetY(), 20), 0, 1, 'C');
        $pdf->Ln(4);
        ...
        return $pdf->outputPdf('PROFORMA-' . $inv_num . '.pdf');
    }
}
